...
<template>
    <ProductModal :show="show" title="Stock In" @close="emit('close')">
        <form @submit.prevent="submit" class="space-y-4">
            ...
            <div class="flex justify-end gap-3">
                ...
                <button type="submit" :disabled="loading" class="rounded-lg bg-emerald-600 px-4 py-2 text-sm text-white">
